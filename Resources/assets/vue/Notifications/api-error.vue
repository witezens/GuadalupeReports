                    ...
                    <div class="p-4">
                        <div class="flex items-start">
                            <div class="flex-shrink-0">
                                <InboxArrowDownIcon class="h-6 w-6 text-red-400" aria-hidden="true" />
                            </div>
                            <div class="ml-3 w-0 flex-1 pt-0.5">
                                <p class="text-sm font-medium text-red-700">API: Error al procesar petición</p>
                                <div v-for="(error, index) in errors" class="mt-1 text-sm text-gray-500">
                                    <dl v-for="message in error">
                                        <dd >{{ message }}</dd>
                                    </dl>
                                </div>
                            </div>
